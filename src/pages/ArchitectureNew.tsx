      ...
      <section id="tools" className="scroll-target section-sm border-b border-border">
        <div className="container-wide">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              24 tools organized into 8 categories for complete memory management.
            </p>
          </div>
        ...
        <div className="container-tight text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <button
              ...
              onClick={() => { trackCTAClick("architecture", "Get Started", "/checkout"); openCheckout(); }}
            >
              Get Started — $49
            </button>
            <Link
