...
export const configurationContent: DocumentationSection = {
  id: 'configuration',
  title: 'Configuration Guide',
  description: 'Complete configuration options and setup for Local Memory',
...
rest_api:
  ...
  port: 3002`,
      language: 'yaml',
      description: 'A minimal configuration file example'
    },
    {
      id: 'env-setup',
      title: 'Environment Configuration',
      code: `export LOCAL_MEMORY_CONFIG_DIR="$HOME/.local-memory"
export MEMORY_REST_API_PORT="3002"
...
# Production profile with environment
export MEMORY_PROFILE="production"
local-memory start`,
      language: 'bash',
      description: 'Switch between different configuration profiles'
    }
  ],
  prevSection: 'getting-started',
  nextSection: 'cli-reference'
};