...
const sessionHash = CryptoJS.SHA256(sessionData).toString().toUpperCase().replace(/[01OI578]/g, '');
...
const timestampHash = CryptoJS.SHA256(timestampData).toString().toUpperCase().replace(/[01OI578]/g, '');
...
const verificationHash = CryptoJS.SHA256(verificationData).toString().toUpperCase().replace(/[01OI578]/g, '');
...
const checksumHash = CryptoJS.SHA256(checksumData).toString().toUpperCase().replace(/[01OI578]/g, '');
